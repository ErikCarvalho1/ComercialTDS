...
delimiter #
           ...
           create procedure comecialtds01.sp_usuario_insert(
    ...
    insert into usuarios values (0, spnome, spemail, md5(spsenha), spnivel_id, 1);
    select * from usuarios where id = last_insert_id();
...
delimiter #
		    ...
		    create procedure comecialnsdb.sp_usuario_update(
   ...
   -- Atributos --
     ...
     begin
        ...
        update usuarios
        set nome = spnome, senha = spsenha, nivel_id = spnivel_id
        where id = spid;
  ...
  delimiter #
           ...
           create procedure comecialnsdb.sp_usuario_arquivar(
  ...
  -- Atributos --
      ...
      begin
           ...
           update usuarios set ativo = 0 where id = spid; 
  ...
  -- SP_USUARIO_RESTAURAR --
  
    delimiter #
    
		   create procedure comecialnsdb.sp_usuario_restaurar(
    ...
    -- Atributos --
     ...
     begin
            ...
            update usuarios set ativo = 1 where id = spid;       
     ...
     delimiter #
           ...
           create procedure comecialnsdb.sp_usuario_delete(
	...
	begin 
          ...
          delete from usuarios where id = spid; 
          
    end #
    
    
    
    -- Fim das procedures de usuarios --
...
delimiter #
           ...
           create procedure comecialnsdb.sp_cliente_insert(
    ...
    insert into clientes values (0,spnome, spcpf, sptelefone, spemail, spdata_nasc, spdata_cad, 1);
...
delimiter #
		    ...
		    create procedure comecialnsdb.sp_cliente_update(
   ...
   -- Atributos --
    ...
    spdata_cad timestamp
     ...
     begin
        ...
        update clientes
        set nome = spnome, cpf = spcpf, telefone = sptelefone, email = spemail, data_nasc = spdata_nasc, data_cad = spdata_cad 
        where id = spid;
  ...
  delimiter #
           ...
           create procedure comecialnsdb.sp_cliente_arquivar(
  ...
  -- Atributos --
      ...
      begin
           ...
           update clientes set ativo = 0 where id = spid; 
	...
	-- SP_CLIENTE_RESTAURAR --
  
    delimiter #
    
		   create procedure comecialnsdb.sp_cliente_restaurar(
    ...
    -- Atributos --
     ...
     begin
            ...
            update clientes set ativo = 1 where id = spid;       
...
delimiter #
           ...
           create procedure comecialnsdb.sp_endereco_insert(
    ...
    insert into enderecos values (0, spcliente_id, spcep, splogradouro, spnumero, spcomplemento, spbairro, spcidade, spuf, sptipo_endereco, 1);
...
delimiter #
		    ...
		    create procedure comecialnsdb.sp_endereco_update(
   ...
   -- Atributos --
     ...
     begin
        ...
        update enderecos
        set cliente_id = spcliente_id, cep = spcep, logradouro = splogradouro, numero = spnumero, complemento = spcomplemento, bairro = spbairro, cidade = spcidade, uf = spuf, tipo_endereco = sptipo_endereco 
        where id = spid;
     ...
     -- SP_ENDERECO_RESTAURAR --
  
    delimiter #
    
		   create procedure comecialnsdb.sp_endereco_restaurar(
    ...
    -- Atributos --
     ...
     begin
            ...
            update enderecos set ativo = 1 where id = spid;       
...
delimiter #
           ...
           create procedure comecialnsdb.sp_categoria_insert(
...
-- aqui iniciamos com os comandos internos da procedure
		   ...
		   insert into categorias (nome, sigla) values (spnome, spsigla);
...
delimiter #
		    ...
		    create procedure comecialnsdb.sp_categoria_update(
...
delimiter #
           ...
           create procedure comecialnsdb.sp_produto_insert(
    ...
    insert into produtos values (0, spcod_barras, spdescricao, spvalor_unit, spunidade_venda, spcategoria_id, spestoque_minimo, spclasse_desconto, spimagem, spdata_cad, spdescontinuado, 1);
    select * from produtos where id = last_insert_id();
...
delimiter #
		    ...
		    create procedure comecialnsdb.sp_produto_update(
   ...
   -- Atributos --
     ...
     begin
        ...
        update produtos
        set cod_barras = spcod_barras, descricao = spdescricao, valor_unit = spvalor_unit, unidade_venda = spunidade_venda, categoria_id = spcategoria_id, estoque_minimo = spestoque_minimo, classe_desconto = spclasse_desconto, imagem = spimagem, data_cad = spdata_cad, descontinuado = spdescontinuado 
        where id = spid;
     ...
     delimiter #
           ...
           create procedure comecialnsdb.sp_produto_delete(
	...
	begin 
          ...
          delete from produtos where id = spid; 
...
-- SP_PRODUTO_ARQUIVAR --
  ...
  delimiter #
           ...
           create procedure comecialnsdb.sp_produto_arquivar(
  ...
  -- Atributos --
      ...
      begin
           ...
           update produtos set descontinuado = 0 where id = spid; 
      ...
      -- SP_PRODUTO_RESTAURAR --
  
    delimiter #
    
		   create procedure comecialnsdb.sp_produto_restaurar(
    ...
    -- Atributos --
     ...
     begin
            ...
            update produtos set descontinuado = 1 where id = spid;       
...
--  produtos, itens produtos, insert de produto
